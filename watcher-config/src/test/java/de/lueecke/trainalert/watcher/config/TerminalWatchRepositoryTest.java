...
public class TerminalWatchRepositoryTest {
	...
	public void findMatchingLowerBound() {
		TerminalWatchJob job = entityManager.persist(new TerminalWatchJob("AH", null, 10, 12, "1111111", true));
	...
	public void findMatchingUpperBound() {
		TerminalWatchJob job = entityManager.persist(new TerminalWatchJob("AST", null, 9, 12, "0000000", true));
	...
	public void dontFindEqualToUpperBound() {
		entityManager.persist(new TerminalWatchJob("AST", null, 12, 13, "1100100", true));
	...
	public void dontFindLowerThanLowerBound() {
		entityManager.persist(new TerminalWatchJob("AST", null, 20, 22, "0001000", true));
	...
	public void dontFindInactive() {
		TerminalWatchJob job = entityManager.persist(new TerminalWatchJob("AH", null, 10, 12, "1111111", false));
		List<TerminalWatchJob> jobs = repository.findByFromHourLessThanEqualAndToHourGreaterThanAndActiveIsTrue(11, 11);
		assertThat(jobs, empty());
	}
