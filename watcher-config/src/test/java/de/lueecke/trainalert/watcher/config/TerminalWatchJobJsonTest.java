...
public class TerminalWatchJobJsonTest {
	...
	public void testSerialize() throws Exception {
		TerminalWatchJob job = new TerminalWatchJob("AH", 10, 20, "0000110");
		// Assert against a `.json` file in the same package as the test
		System.out.println(json.write(job).getJson());
		this.json.write(job).assertThat().isEqualToJson(
				"{\"id\":null,\"terminalId\":\"AH\",\"fromHour\":10,\"toHour\":20,\"activeOnWeekdays\":[\"MONDAY\",\"TUESDAY\"]}");
	}

	@Test
	public void testDeserialize() throws Exception {
		String content = "{\"terminalId\":\"ATST\",\"fromHour\":20,\"toHour\":22,\"activeOnWeekdays\":[\"MONDAY\",\"WEDNESDAY\",\"FRIDAY\"]}";
